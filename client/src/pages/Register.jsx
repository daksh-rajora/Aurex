...
export const Register = () => {
  return (
    <div className="min-h-screen w-full bg-[#0B1120] text-slate-100 flex flex-col justify-between items-center px-4 py-6 relative overflow-hidden font-sans select-none">
      ...
      <div className="w-full flex-1 flex items-center justify-center py-4">
        <AuthCard
          ...
          title="Create your Aurex account"
          subtitle="Build your AI-powered developer profile and start analyzing repositories."
        >
          <RegisterForm />
        </AuthCard>
      </div>
      ...
      <footer className="w-full max-w-5xl mx-auto pt-4 border-t border-[#2A3247]/40 flex flex-col sm:flex-row items-center justify-between text-xs text-[#94A3B8] gap-4 relative z-10">
